...
export class ChatbotAvgResponseTimeDto {
  @ApiProperty({ example: 45, description: 'Average embedding preparation duration in ms' })
  avgEmbeddingMs!: number;

  @ApiProperty({ example: 120, description: 'Average document search duration in ms' })
  avgSearchMs!: number;

  @ApiProperty({ example: 1100, description: 'Average Gemini API call duration in ms' })
  avgGeminiMs!: number;

  @ApiProperty({ example: 35, description: 'Average DB saving duration in ms' })
  avgSaveDbMs!: number;

  @ApiProperty({ example: 1300, description: 'Average total response time in ms' })
  avgTotalMs!: number;
}
...
export class ChatbotStatsResponseDto {
  @ApiProperty({ example: 150, description: 'Total chatbot questions processed' })
  ...
  @ApiProperty({ example: 18, description: 'Number of fallback keyword search occurrences' })
